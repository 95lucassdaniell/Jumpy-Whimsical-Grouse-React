  ...
  transition: none;
      ...
      <div id="empreenda-tshirt-page">
        ...
        <section className="product-section">
          <h2 className="section-title">Catálogo Atacado de Qualidade</h2>
          <p className="section-subtitle">
            {' '}
            T-shirts 100% algodão, acabamento superior e variedade para seu
            negócio
            <span
              dangerouslySetInnerHTML={{
                __html: ' ',
          ...
          <div className="product-grid">
            <div className="product-tile product-tile--lead">
              <img
                alt="Coleção completa de t-shirts para revenda"
                src="https://images.pexels.com/photos/14528152/pexels-photo-14528152.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=1500"
                loading="lazy"
              />
              <div className="product-tile__content">
                <span className="product-tile__badge">Best Seller</span>
                <h3 className="product-tile__title">Coleção Premium</h3>
                <p className="product-tile__desc">
                  {' '}
                  Variedade de modelos, cores e estampas pensadas para rápido
                  giro
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
            ...
            <div className="product-tile">
              <img
                alt="T-shirts básicas coloridas"
                src="https://images.pexels.com/photos/9940948/pexels-photo-9940948.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=1500"
                loading="lazy"
              />
              <div className="product-tile__content">
                <h3 className="product-tile__title">T-Shirts Básicas</h3>
                <p className="product-tile__desc">Do P ao GG</p>
              </div>
            </div>
            <div className="product-tile">
              <img
                alt="Coleção de t-shirts estampadas"
                src="https://images.pexels.com/photos/17097094/pexels-photo-17097094.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=1500"
                loading="lazy"
              />
              <div className="product-tile__content">
                <h3 className="product-tile__title">Estampas Exclusivas</h3>
                <p className="product-tile__desc">Designs únicos</p>
              </div>
            </div>
            <div className="product-tile">
              <img
                alt="T-shirts organizadas por cores"
                src="https://images.pexels.com/photos/253668/pexels-photo-253668.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=1500"
                loading="lazy"
              />
              <div className="product-tile__content">
                <h3 className="product-tile__title">Cores Variadas</h3>
                <p className="product-tile__desc">Sólidas e vibrantes</p>
              </div>
            </div>
            <div className="product-tile">
              <img
                alt="T-shirts minimalistas brancas"
                src="https://images.pexels.com/photos/9594682/pexels-photo-9594682.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=1500"
                loading="lazy"
              />
              <div className="product-tile__content">
                <h3 className="product-tile__title">Linha Minimalista</h3>
                <p className="product-tile__desc">Elegância simples</p>
              </div>
            </div>
            <div className="product-tile">
              <img
                alt="Variedade de modelos de roupas"
                src="https://images.pexels.com/photos/8386643/pexels-photo-8386643.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=1500"
                loading="lazy"
              />
              <div className="product-tile__content">
                <span className="product-tile__badge">Novidade</span>
                <h3 className="product-tile__title">Cropped &amp; Mais</h3>
                <p className="product-tile__desc">Modelos diversos</p>
              </div>
            </div>
            <div className="product-tile">
              <img
                alt="Coleção de roupas femininas"
                src="https://images.pexels.com/photos/5531540/pexels-photo-5531540.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=1500"
                loading="lazy"
              />
              <div className="product-tile__content">
                <h3 className="product-tile__title">Coleção Completa</h3>
                <p className="product-tile__desc">Gola alta e mais</p>
              </div>
            </div>
            <div className="product-tile">
              <img
                alt="Cliente navegando em boutique"
                src="https://images.pexels.com/photos/7679720/pexels-photo-7679720.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=1500"
                loading="lazy"
              />
              <div className="product-tile__content">
                <h3 className="product-tile__title">Qualidade Garantida</h3>
                <p className="product-tile__desc">100% algodão</p>
              </div>
            </div>
          </div>
          <div className="product-split">
            <div className="product-benefits">
              ...
              <div className="product-benefits__list">
                <div className="product-benefits__item">
                  ...
                  <span>
                    {' '}
                    Matéria-prima premium com controle de qualidade rigoroso
                    <span
                      dangerouslySetInnerHTML={{
                        __html: ' ',
                      }}
                ...
                <div className="product-benefits__item">
                  ...
                  <span>Modelos testados no mercado com alta aceitação</span>
                </div>
                <div className="product-benefits__item">
                  <svg
                    width="24"
                  ...
                  <span>Fotos editoriais prontas para seus anúncios</span>
                </div>
                <div className="product-benefits__item">
                  <svg
                    width="24"
                  ...
                  <span>Kits curados para fácil revenda e alto giro</span>
                </div>
              </div>
              <a href="https://atacado.minhatshirt.com.br/#formulario-wpp">
                <div
                  aria-label="Solicitar catálogo completo"
                  className="btn btn-primary"
                >
                  <span>
                    {' '}
            ...
            <div className="product-support">
              <div className="product-support__card">
                <svg
                  width="32"
                  xmlns="http://www.w3.org/2000/svg"
                  height="32"
                ...
                <h4>Envio em 3 dias úteis</h4>
                <p>Logística eficiente com mais de 93.530 pedidos entregues</p>
              </div>
              <div className="product-support__card">
                <svg
                  width="32"
                ...
                <h4>Margem até 200%</h4>
                <p>Preço atacado competitivo para maximizar seu lucro</p>
              </div>
              <div className="product-support__card">
                <svg
                  width="32"
                ...
                <p>Consultoria para escolher mix e precificação ideal</p>
              </div>
            </div>
          </div>
        </section>
